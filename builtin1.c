...
/**
 * _myhistory - this displays the history list, one command each line, preceded
 ...
 * @str: string alias
 *
 * Return: should Always return 0 if success, or 1 on error
 */
 ...
 * @str: string alias
 *
 * Return: should Always 0 if success, or 1 on error
 */
