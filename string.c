...
/**
 * _strcmp - this performs a lexico comparison of two strangs.
 * @s1: first strang
 * @s2: second strang
 *
 * Return: retruns negative if s1 < s2, positive if s1 > s2, zero if s1 == s2
 */
 ...
 * @haystack: the string to a search
