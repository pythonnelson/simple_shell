...
/**
 * is_chain - this test if the current char in buffer is a chain delimeter
 * @info: parameter struct
 * @buf: char buffer
 * @p: the address of the current position in buf
 *
 * Return: returns 1 if chain delimeter, else returns 0
 */
 ...
 * @info: parameter struct
 *
 * Return: return 1 if replaced, else 0
 */
